...
const nav=[["/app","Visão geral",LayoutDashboard],["/app/movimentos","Movimentos",Wallet],["/app/assinaturas","Assinaturas",Repeat2],["/app/metas","Metas",Flag],["/app/relatorios","Relatórios",TrendingUp],["/app/configuracoes","Configurações",Settings]]as const;const categories=["Casa","Alimentação","Transporte","Saúde","Educação","Lazer","Assinaturas","Outros","Salário","Renda extra"];
